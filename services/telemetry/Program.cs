...
using Journey.Telemetry.Api.Infrastructure.Seeding;
...
if (bool.Parse(builder.Configuration["Redis:Enabled"] ?? "false"))
{
    ...
    builder.Services.AddScoped<ITelemetryCacheService, RedisTelemetryCacheService>();
}
...
builder.Services.AddSingleton<TelemetryDatabaseSeeder>();

var app = builder.Build();

await using (var scope = app.Services.CreateAsyncScope())
{
    var seeder = scope.ServiceProvider.GetRequiredService<TelemetryDatabaseSeeder>();
